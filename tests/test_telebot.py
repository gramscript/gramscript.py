...
def deprecated1_old_function():
    ...
    warnings.warn(
        "The 'deprecated1_old_function' is deprecated. Use `deprecated1_new_function` instead", DeprecationWarning, 2)
...
class TestTeleBot:
    ...
    def test_send_media_group(self):
        ...
        medias = [types.InputMediaPhoto(
            img1, "View"), types.InputMediaPhoto(img2, "Dog")]
    ...
    def test_chat_commands(self):
        ...
        scope = gramscript.types.BotCommandScopeChat(CHAT_ID)
        ret_msg = tb.set_my_commands(
            [gramscript.types.BotCommand(command, description)], scope, lang)
    ...
    def test_typed_middleware_handler(self):
        from gramscript import apihelper
