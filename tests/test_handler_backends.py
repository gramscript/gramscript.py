from gramscript.handler_backends import MemoryHandlerBackend, FileHandlerBackend
...
if REDIS_TESTS:
    from gramscript.handler_backends import RedisHandlerBackend


@pytest.fixture()
def telegram_bot():
    return gramscript.TeleBot('', threaded=False)
