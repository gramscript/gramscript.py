...
def test_json_message():
    ...
    msg = Message.de_json(jsonstring)
...
def test_json_InlineKeyboardMarkup():
    ...
    markup = InlineKeyboardMarkup.de_json(jsonstring)
...
def test_json_InlineKeyboardButton():
    ...
    button = InlineKeyboardButton.de_json(jsonstring)
...
def test_json_message_with_dice():
    ...
    assert isinstance(msg.dice, Dice)
...
def test_json_message_group():
    ...
    msg = Message.de_json(json_string)
    assert msg.text == 'HIHI'
...
def test_json_GroupChat():
    ...
    gc = GroupChat.de_json(json_string)
    assert gc.id == 8926
...
def test_json_Document():
    ...
    doc = Document.de_json(json_string)
...
def test_json_UserProfilePhotos():
    ...
    upp = UserProfilePhotos.de_json(json_string)
...
def test_json_contact():
    ...
    contact = Contact.de_json(json_string)
...
def test_json_voice():
    ...
    voice = Voice.de_json(json_string)
...
def test_InlineQueryResultCachedPhoto():
    iq = InlineQueryResultCachedPhoto('aaa', 'Fileid')
    json_str = iq.to_json()
...
def test_InlineQueryResultCachedPhoto_with_title():
    iq = InlineQueryResultCachedPhoto('aaa', 'Fileid', title='Title')
    json_str = iq.to_json()
    assert 'aa' in json_str
    assert 'Fileid' in json_str
...
def test_InlineQueryResultCachedPhoto_with_markup():
    ...
    markup.add(InlineKeyboardButton("Yahoo", url="http://www.yahoo.com"))
    iq = InlineQueryResultCachedPhoto(
...
def test_json_poll_answer():
    ...
    poll_answer = PollAnswer.de_json(jsonstring)
    assert poll_answer.poll_id == '5895675970559410186'
    assert isinstance(poll_answer.user, User)
    assert poll_answer.option_ids == [1]


def test_KeyboardButtonPollType():
    markup = ReplyKeyboardMarkup()
    markup.add(KeyboardButton('send me a poll',
...
def test_json_chat_invite_link():
    ...
    invite_link = ChatInviteLink.de_json(json_string)
    assert invite_link.invite_link == 'https://t.me/joinchat/MeASP-Wi...'
    assert isinstance(invite_link.creator, User)
...
def test_chat_member_updated():
    ...
    cm_updated = ChatMemberUpdated.de_json(json_string)
