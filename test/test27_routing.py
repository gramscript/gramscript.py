...
top_router = gramscript.helper.Router(random_key, {0: zero,
                                                   1: one,
                                                   2: two,
                                                   3: three,
                                                   (None,): none_tuple,
...
command_router = gramscript.helper.Router(lower_key(by_chat_command()),
...
regex_router = gramscript.helper.Router(by_regex(lambda msg: msg['text'], '(CS[0-9]{3})'),
