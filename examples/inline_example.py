...
bot = gramscript.TeleBot(API_TOKEN)
gramscript.logger.setLevel(logging.DEBUG)
...
def query_video(inline_query):
    try:
        r = types.InlineQueryResultVideo('1',
                                         'https://github.com/gramscript/gramscript.py/blob/master/tests/test_data/test_video.mp4?raw=true',
                                         'video/mp4', 'Video',
                                         'https://raw.githubusercontent.com/eternnoir/pyTelegramBotAPI/master/examples/detailed_example/rooster.jpg',
                                         'Title'
                                         )
