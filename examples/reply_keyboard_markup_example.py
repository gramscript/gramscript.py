...
import gramscript
from gramscript.types import ReplyKeyboardMarkup, KeyboardButton
...
def keyboard(key_type="Normal"):
    ...
    if key_type == "Normal":
        ...
        markup.add(*row)
        markup.add(KeyboardButton("Caps Lock"), KeyboardButton(
            "Symbols"), KeyboardButton("🔙Delete"), KeyboardButton("✅Done"))
        ...
        markup.add(*row)
        markup.add(KeyboardButton("Caps Lock"), KeyboardButton(
            "Normal"), KeyboardButton("🔙Delete"), KeyboardButton("✅Done"))
    else:
        ...
        markup.add(*row)
        markup.add(KeyboardButton("Normal"), KeyboardButton("Symbols"),
                   KeyboardButton("🔙Delete"), KeyboardButton("✅Done"))
    return markup
...
def all_messages(message):
    if message.text == "✅Done":
        markup = gramscript.types.ReplyKeyboardRemove()
        bot.send_message(message.from_user.id,
                         "Done with Keyboard", reply_markup=markup)
