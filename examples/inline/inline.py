...
from gramscript.delegate import per_inline_from_id, create_open, pave_event_space
...
class InlineHandler(gramscript.helper.InlineUserHandler, gramscript.helper.AnswererMixin):
