...
bot = gramscript.TeleBot(Token, parse_mode="HTML")
...
def newmember(msg):
    ...
    invite = bot.create_chat_invite_link(Group_ID, member_limit=1, expire_date=int(
        time())+45)  # Here, the link will auto-expire in 45 seconds
    ...
    bot.send_message(
        msg.chat.id, f"Hey there {msg.from_user.first_name}, Click the link below to join our Official Group.", reply_markup=mrkplink)
