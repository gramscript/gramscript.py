...
votes = gramscript.helper.SafeDict()  # thread-safe dict


class VoteCounter(gramscript.helper.ChatHandler):
    def __init__(self, *args, **kwargs):
        ...
        self._member_count = self.administrator.getChatMembersCount() - \
    ...
    def _init_ballot(self):
        ...
        self._ballot_box = {}
        self._keyboard_msg_ident = gramscript.message_identifier(sent)
        self._editor = gramscript.helper.Editor(
    ...
    def _close_ballot(self):
        ...
        except gramscript.exception.EventNotFound:
            pass
    ...
    def on_callback_query(self, msg):
        ...
        if from_id in self._ballot_box:
            self.bot.answerCallbackQuery(
                query_id, text=f'You have already voted {self._ballot_box[from_id]}')
    ...
    def on_close(self, ex):
        ...
        if self._ballot_box is None:
            ...
            votes[self.id] = (self._ballot_box,
                              self._keyboard_msg_ident, self._expired_event)
