import gramscript
from gramscript import types, util
...
def chat_m(message: types.ChatMemberUpdated):
    ...
    if new.status == "member":
        bot.send_message(message.chat.id, "Hello {name}!".format(
            name=new.user.first_name))  # Welcome message
...
def my_chat_m(message: types.ChatMemberUpdated):
    ...
    if new.status == "member":
        ...
        bot.send_message(message.chat.id, "Somebody added me to group")
