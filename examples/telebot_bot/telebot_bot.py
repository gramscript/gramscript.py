...
text_messages = {
    'welcome':
        ...
        u'project\'s documentation (https://github.com/gramscript/gramscript.py/blob/master/README.md) and the '
        u'examples (https://github.com/gramscript/gramscript.py/tree/master/examples) first.\n\n'
...
bot = gramscript.AsyncTeleBot(os.environ["TELEBOT_BOT_TOKEN"])
