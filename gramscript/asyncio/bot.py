# -*- coding: utf-8 -*-
from asyncio import asyncio_filters, asyncio_helper
from asyncio import asyncio_handler_backends
import asyncio
...
class Asyncgramscript:
    """ This is Asyncgramscript Class
    Methods:
        getMe
        logOut
        close
    ...
    async def get_updates(self, offset: Optional[int] = None, limit: Optional[int] = None,
                          timeout: Optional[int] = None, allowed_updates: Optional[List] = None, request_timeout: Optional[int] = None) -> List[Update]:
    ...
    async def _process_polling(self, non_stop: bool = False, interval: int = 0, timeout: int = 20, request_timeout: int = 20, allowed_updates: Optional[List[str]] = None):
        """
    ...
    async def _process_updates(self, handlers, messages, update_type):
        ...
        for message in messages:
            ...
            self._loop_create_task(self._run_middlewares_and_handlers(
                handlers, message, middleware))
    ...
    async def process_middlewares(self, update, update_type):
        return next((middleware for middleware in self.middlewares if update_type in middleware.update_types), None)
    ...
    def message_handler(self, commands=None, regexp=None, func=None, content_types=None, chat_types=None, **kwargs):
        ...
        :param content_types: Supported message content  Must be a list. async defaults to ['text'].
    ...
    async def get_file(self, file_id: str) -> File:
        ...
        """
        return File.de_json(await asyncio_helper.get_file(self.token, file_id))
    ...
    def enable_saving_states(self, filename="./.state-save/states.pkl"):
        ...
        self.current_states = asyncio_handler_backends.StateFile(
            filename=filename)
    ...
    async def set_chat_sticker_set(self, chat_id: Union[int, str], sticker_set_name: str) -> StickerSet:
        """
    ...
    async def get_my_commands(self, scope: Optional[BotCommandScope],
    ...
    async def delete_my_commands(self, scope: Optional[BotCommandScope] = None,
    ...
    async def edit_message_text(
            ...
            entities: Optional[List[MessageEntity]] = None,
            disable_web_page_preview: Optional[bool] = None,
            reply_markup: Optional[REPLY_MARKUP_TYPES] = None) -> Union[Message, bool]:
        """
    ...
    async def edit_message_media(self, media: Any, chat_id: Optional[Union[int, str]] = None, message_id: Optional[int] = None, inline_message_id: Optional[str] = None, reply_markup: Optional[REPLY_MARKUP_TYPES] = None) -> Union[Message, bool]:
        """
    ...
    async def edit_message_reply_markup(self, chat_id: Optional[Union[int, str]] = None, message_id: Optional[int] = None, inline_message_id: Optional[str] = None, reply_markup: Optional[REPLY_MARKUP_TYPES] = None) -> Union[Message, bool]:
        """
    ...
    async def set_game_score(self, user_id: Union[int, str], score: int, force: Optional[bool] = None, chat_id: Optional[Union[int, str]] = None, message_id: Optional[int] = None, inline_message_id: Optional[str] = None, disable_edit_message: Optional[bool] = None) -> Union[Message, bool]:
        """
        ...
        :return:
        """
        result = await asyncio_helper.set_game_score(self.token, user_id, score, force, disable_edit_message, chat_id, message_id, inline_message_id)
    ...
    async def stop_poll(
        ...
        :return:
        """
        return Poll.de_json(await asyncio_helper.stop_poll(self.token, chat_id, message_id, reply_markup))
    ...
    async def edit_message_caption(self, caption: str, chat_id: Optional[Union[int, str]] = None, message_id: Optional[int] = None, inline_message_id: Optional[str] = None, parse_mode: Optional[str] = None, caption_entities: Optional[List[MessageEntity]] = None, reply_markup: Optional[REPLY_MARKUP_TYPES] = None) -> Union[Message, bool]:
        """
        ...
        """
        parse_mode = self.parse_mode if parse_mode is None else parse_mode
        result = await asyncio_helper.edit_message_caption(self.token, caption, chat_id, message_id, inline_message_id, parse_mode, caption_entities, reply_markup)
    ...
    async def upload_sticker_file(self, user_id: int, png_sticker: Union[Any, str]) -> File:
        """
