...
def flance(msg, long=False):
    """
    A combination of :meth:`gramscript.flavor` and :meth:`gramscript.glance`,
    return a 2-tuple (flavor, headline_info), where *headline_info* is whatever extracted by
    :meth:`gramscript.glance` depending on the message flavor and the ``long`` parameter.
    """
    f = flavor(msg)
...
def fleece(event):
    """
    A combination of :meth:`gramscript.flavor` and :meth:`gramscript.peel`,
...
class Bot(_BotBase):
    ...
    def sendAudio(self, chat_id, audio,
        ...
        :param audio: Same as ``photo`` in :meth:`gramscript.Bot.sendPhoto`
        """
    ...
    def sendDocument(self, chat_id, document,
        ...
        :param document: Same as ``photo`` in :meth:`gramscript.Bot.sendPhoto`
        """
    ...
    def sendVideo(self, chat_id, video,
        ...
        :param video: Same as ``photo`` in :meth:`gramscript.Bot.sendPhoto`
        """
    ...
    def sendVoice(self, chat_id, voice,
        ...
        :param voice: Same as ``photo`` in :meth:`gramscript.Bot.sendPhoto`
        """
    ...
    def sendVideoNote(self, chat_id, video_note,
        ...
        :param video_note: Same as ``photo`` in :meth:`gramscript.Bot.sendPhoto`
    ...
    def editMessageCaption(self, msg_identifier,
        ...
        :param msg_identifier: Same as ``msg_identifier`` in :meth:`gramscript.Bot.editMessageText`
        """
        p = _strip(locals(), more=['msg_identifier'])
        p.update(_dismantle_message_identifier(msg_identifier))
    ...
    def deleteMessage(self, msg_identifier):
        ...
        :param msg_identifier:
            Same as ``msg_identifier`` in :meth:`gramscript.Bot.editMessageText`,
    ...
    def sendSticker(self, chat_id, sticker,
        ...
        :param sticker: Same as ``photo`` in :meth:`gramscript.Bot.sendPhoto`
        """
    ...
    def setGameScore(self, user_id, score, game_message_identifier,
        ...
        :param game_message_identifier: Same as ``msg_identifier`` in :meth:`gramscript.Bot.editMessageText`
        """
    ...
    def message_loop(self, callback=None, relax=0.1,
        ...
        :type timeout: int
        :param timeout:
            ``timeout`` parameter supplied to :meth:`gramscript.Bot.getUpdates`,
            controlling how long to poll.

        :type allowed_updates: array of string
        :param allowed_updates:
            ``allowed_updates`` parameter supplied to :meth:`gramscript.Bot.getUpdates`,
