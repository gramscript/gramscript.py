...
-   If a bot accepts inline queries, you can call it by using
    :meth:`~gramscript.Client.get_inline_bot_results` to get the list of its inline results for a query:
...
-   After you retrieved the bot results, you can use
    :meth:`~gramscript.Client.send_inline_bot_result` to send a chosen result to any chat:
