...
gramscript supports proxies with and without authentication. This feature allows gramscript to exchange data with Telegram
...
-  To use gramscript with a proxy, simply append the following to your ``config.ini`` file and replace the values
