...
This page contains example scripts to show you how gramscript looks like.
...
.. csv-table::
    ...
    :doc:`welcomebot`, "The Welcome Bot in @gramscriptChat"
...
For more advanced examples, see https://snippets.gramscript.org.
