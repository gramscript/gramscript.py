...
.. code-block:: python
    ...
    from gramscript.types import ReplyKeyboardMarkup, InlineKeyboardMarkup, InlineKeyboardButton
                ...
                [
                    [  # First row
                        ...
                        InlineKeyboardButton(  # Opens a web URL
                            "URL",
                            url="https://docs.gramscript.org"
                        ),
                    ],
                    [  # Second row
                        InlineKeyboardButton(  # Opens the inline interface
                            "Choose chat",
                            switch_inline_query="gramscript"
                        ),
                        InlineKeyboardButton(  # Opens the inline interface in the current chat
                            "Inline here",
                            switch_inline_query_current_chat="gramscript"
                        )
                    ]
                ]
            )
